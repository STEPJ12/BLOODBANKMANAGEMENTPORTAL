...
$row = getRow("
    SELECT r.id, r.referral_document_name, r.referral_document_type, r.referral_document_data
    FROM referrals r
...
header('Content-Disposition: inline; filename="' . $row['referral_document_name'] . '"');
