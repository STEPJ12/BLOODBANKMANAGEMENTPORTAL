...
error_log("View Blood Card - Request ID: " . $requestId);
error_log("View Blood Card - DB Path: " . $dbPath);
error_log("View Blood Card - File Path: " . $filePath);
...
if (!$resolvedPath || !file_exists($resolvedPath)) {
    ...
    if (!$found) {
        http_response_code(404);
        header('Content-Type: text/html');
        error_log("View Blood Card - File not found. Tried paths: " . implode(", ", $altPaths));
