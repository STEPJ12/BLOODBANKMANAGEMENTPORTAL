...
<head>
    ...
    <title>Contact Us - Philippine Red Cross</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        :root {
            --primary-color: #d22a33;
       ...
       /* Navbar Styles */
        ...
        /* Hero Section */
        .hero-section {
            background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('imgs/contact.png');
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link selected" href="contactrc-details.php">Contact Us</a>
                        </li>
                    </ul>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="contact-card text-center">
                    ...
                    <h3>Visit Us</h3>
                    <p>10th St, Bacolod, 6100 Negros Occidental</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="contact-card text-center">
                    ...
                    <h3>Email Us</h3>
                    <p>communication@redcross.org.ph</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="map-container">
                    <iframe src="https://www.google.com/maps?q=10th%20St%2C%20Bacolod%20City&hl=en&z=16&output=embed"
                            width="100%" height="450" style="border:0;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="Google Maps showing Red Cross location at 10th Street, Bacolod City"></iframe>
                </div>
            </div>
            <div class="col-md-6">
