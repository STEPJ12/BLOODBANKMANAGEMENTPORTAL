            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/blood/aboutnf.php">About Us</a></li>
                        <li class="nav-item"><a class="nav-link selected" href="/blood/contact.php">Contact Us</a></li>
                    </ul>
                                ...
                                <div class="contact-info-item">
                                    ...
                                    <div class="contact-info-text">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            Sunday: Closed<br>
                                            <small class="text-muted"><i class="bi bi-info-circle me-1"></i>Emergency: 24/7</small>
                                        </p>
                                    </div>
                                </div>
                            </div>
