            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item">
                            <a class="nav-link selected" href="redcrossportal.php">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="aboutrc.html">About Us</a>
                        </li>
                       
                        <li class="nav-item">
                            <a class="nav-link" href="contactrc.html">Contact Us</a>
                        </li>
                    </ul>
                    <div class="d-flex ms-3" role="group" aria-label="Quick actions">
                        <button class="btn login" onclick="window.location.href = 'loginredcross.php';" aria-label="Login as Red Cross">Login</button>
                    </div>
                </div>
            </div>
        </nav>
